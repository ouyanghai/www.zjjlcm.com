...
class WebController extends TopController{
	public $menu =array();
	//客服固定超链接
	public $connect_link = "http://ala.zoosnet.net/LR/Chatpre.aspx?id=ALA29166467&lng=cn";
	//客服系统需要的js
	public $link_js = "http://ala.zoosnet.net/JS/LsJS.aspx?siteid=ALA29166467&float=1&lng=cn";
